...
<section class="wizard-pesan pt-0">
    <form action="#" method="POST" enctype="multipart/form-data" id="myform">
                    ...
                    <div class="packages-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="content-package">
                                            ...
                                            <h2 class="mb-4">Rp <span class="price">1</span> juta</h2>
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[1]; ?>" data="<?php echo $nama[1]; ?>" data-harga="<?php echo $harga[1] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="content-package">
                                            <p>Ditujukan untuk membantu usaha baru agar dapat Go Online dengan #TerimaBeres</p>
                                            <h2 class="mb-4">Rp <span class="price">1,8</span> juta</h2>
                                            <!-- <p class="title-fitur">Semua fitur dari Paket UKM</p> -->
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[5]; ?>" data="<?php echo $nama[5]; ?>" data-harga="<?php echo $harga[5] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="content-package">
                                            ...
                                            <h2 class="mb-4">Rp <span class="price">2,7</span> juta</h2>
                                            <!-- <p class="title-fitur">Semua fitur dari Paket UKM</p> -->
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[0]; ?>" data="<?php echo $nama[0]; ?>" data-harga="<?php echo $harga[0] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="content-package">
                                            ...
                                            <h2 class="mb-4">Rp <span class="price">4,5</span> juta</h2>
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[6]; ?>" data="<?php echo $nama[6]; ?>" data-harga="<?php echo $harga[6] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="content-package">
                                            ...
                                            <h2 class="mb-4">Rp <span class="price">9,5</span> juta</h2>
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[7]; ?>" data="<?php echo $nama[7]; ?>" data-harga="<?php echo $harga[7] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[4]; ?>" data="<?php echo $nama[4]; ?>" data-harga="<?php echo $harga[4] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 min-he-50">
                                        <div class="text-right">
                                            ...
                                            <a href="#" class="btn btn-pesan" data-pid="<?php echo $pid[2]; ?>" data="<?php echo $nama[2]; ?>" data-harga="<?php echo $harga[2] ?>">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-md-5 mt-3">
                            <div class="d-md-flex d-block justify-content-center align-items-center">
                                ...
                                <a href="<?=home_url('/hubungi')?>" class="btn btn-hub ml-md-3">Hubungi Kami</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section-pesan section-cari-domain container" id="cari-domain">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <input type="text" class="form-control m-auto w-md-50" id="input-cari-domain" placeholder="example.com">
                </div>
                ...
                <div class="col-12 text-center">
                    <input type="text" class="form-control m-auto w-md-50" id="input-transfer-domain" placeholder="example.com">
                </div>
            ...
            <div class="container mt-5">
                <div class="btn-next-back">
                    ...
                    <input type="button" class="btn next-step disable-btn" id="nextto-template" value="Next" disabled>
                </div>
            </div>
                    ...
                    <div class="px-3">
                        ...
                        <div class="table-summary">
                            <table class="wrapp-total">
                                ...
                                <tr class="t-body">
                                    <td><b>Total</b></td>
                                    <td><b>Rp. <span id="total-harga">2700000</span><b></td>
                                </tr>
