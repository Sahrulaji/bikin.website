            ...
            <div class="row cover-page">
                <div class="col-md-7 header-left">
                    ...
                    <p class="cover-subtitle">
                        <a href="<?=home_url('/')?>">BIKIN.WEBSITE</a> bekerja bersama berbagai macam wirausaha dan tokoh tokoh ternama yang tersebar di
    ...
    <section class="portfolio">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <p class="cover-subtitle"><a href="<?=home_url('/')?>">BIKIN.WEBSITE</a> telah bekerjasama dengan berbagai macam bidang usaha yang tersebar di seluruh Indonesia. Temukan inspirasi website dari mereka yang telah sukses dengan bantuan jasa kami.</p>
            </div>
