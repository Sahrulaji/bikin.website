                            ...
                            <div class="card-body">
                                        ...
                                        <div class="harga-promo">
                                                ...
                                                <div class="wrapper-promo">
                                                        ...
                                                        <div class="d-flex align-items-end">
                                                                <span class="nominal text-blue">2,7</span>
                                                                <span class="juta text-blue">&nbsp;juta</span>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
                                ...
                                <div class="wrapper">
                                    <ul class="list-harga">
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">Simple 5 Image Editing</li>
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">3 Hari Kerja Durasi Pengerjaan</li>
                                    </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="wrapper">
                                    <ul class="list-harga">
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">Simple 15 Image Editing</li>
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                     ...
                                     <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">7 Hari Kerja Durasi Pengerjaan</li>
                                    </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="wrapper">
                                    <ul class="list-harga">
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">Simple 25 Image Editing</li>
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">5 Pilihan Logo</li>
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">3x Revisi Design</li>
                                        ...
                                        <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/harga-page/black-check-mark-png-md.svg"
                                                class="tick-icon" alt="tick-icon">14 Hari Pekerjaan</li>
                                    </ul>
